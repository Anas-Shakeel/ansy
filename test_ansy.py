...
def test_colored_basic():
    ...
    # 8Bit
    assert ansy.colored(s, 'blue', color_mode=8,
                        force_color=True) == '\x1b[38;5;4mThis is string.\x1b[0m'
    assert ansy.colored(s, 'plum', 234, color_mode=8,
                        force_color=True) == '\x1b[48;5;234m\x1b[38;5;183mThis is string.\x1b[0m'

    # 24Bit
    assert ansy.colored(s, (255, 100, 100), '#FFF', color_mode=24,
                        force_color=True) == '\x1b[48;2;255;255;255m\x1b[38;2;255;100;100mThis is string.\x1b[0m'
    assert ansy.colored(s, '#FFFFFF', (50, 50, 100), color_mode=24,
                        force_color=True) == '\x1b[48;2;50;50;100m\x1b[38;2;255;255;255mThis is string.\x1b[0m'


def test_colored_advanced():
    assert ansy.colored('This is string.', 'blue', attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[34mThis is string.\x1b[0m"
    assert ansy.colored('This is string.', 'blue', 'dark_grey', attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[100m\x1b[34mThis is string.\x1b[0m"
    assert ansy.colored('This is string.', 'blue', color_mode=8, attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[38;5;4mThis is string.\x1b[0m"
    assert ansy.colored('This is string.', 'plum', 234, color_mode=8, attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[48;5;234m\x1b[38;5;183mThis is string.\x1b[0m"
    assert ansy.colored('This is string.', (255, 100, 100), '#FFF', color_mode=24, attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[48;2;255;255;255m\x1b[38;2;255;100;100mThis is string.\x1b[0m"
    assert ansy.colored('This is string.', '#FFFFFF', (50, 50, 100), color_mode=24, attrs=[
                        'bold', 'italic', 'strike', 'overline', 'underline'], force_color=True) == "\x1b[4m\x1b[53m\x1b[9m\x1b[3m\x1b[1m\x1b[48;2;50;50;100m\x1b[38;2;255;255;255mThis is string.\x1b[0m"
...
def test_colored_errors():
    ...
    with raises(InvalidColorError):
        ansy.colored(s, bgcolor=(255, 502, 10),
                     force_color=True, color_mode=24)
...
def test_colored_ansy():
    ...
    assert ansy.colored_ansy("Welcome to @red[ansy] @yellow[:)]",
                             style, force_color=True) == 'Welcome to \x1b[38;2;255;85;85mansy\x1b[0m \x1b[38;2;240;194;123m:)\x1b[0m'

    with raises(StyleError):
        ansy.colored_ansy(
            "Welcome to @red[ansy] @asd[:)]", style, force_color=True)

    with raises(ColorModeError):
        ansy.colored_ansy(
            "Welcome to @red[ansy] @invalid[:)]", style, force_color=True)


def test_colored_gradient():
    assert ansy.colored_gradient(
        'asd', (25, 25, 100), (1, 1, 1)) == '\x1b[38;2;25;25;100ma\x1b[38;2;13;13;50ms\x1b[38;2;1;1;1md\x1b[0m'
    assert ansy.colored_gradient('asd', (25, 25, 100), (1, 1, 1),
                                 reverse=True) == '\x1b[38;2;1;1;1ma\x1b[38;2;13;13;50ms\x1b[38;2;25;25;100md\x1b[0m'
    assert ansy.colored_gradient(
        'a', (25, 25, 100), (1, 1, 1)) == '\x1b[38;2;25;25;100ma\x1b[0m'
    assert ansy.colored_gradient(
        'This is quality test', "#ff22ff", "b00b1e", 'high') == '\x1b[38;2;255;34;255mT\x1b[38;2;250;32;243mh\x1b[38;2;246;31;231mi\x1b[38;2;242;30;219ms\x1b[38;2;238;29;207m \x1b[38;2;234;27;195mi\x1b[38;2;230;26;183ms\x1b[38;2;225;25;172m \x1b[38;2;221;24;160mq\x1b[38;2;217;23;148mu\x1b[38;2;213;21;136ma\x1b[38;2;209;20;124ml\x1b[38;2;205;19;112mi\x1b[38;2;200;18;101mt\x1b[38;2;196;17;89my\x1b[38;2;192;15;77m \x1b[38;2;188;14;65mt\x1b[38;2;184;13;53me\x1b[38;2;180;12;41ms\x1b[38;2;176;11;30mt\x1b[0m'
    assert ansy.colored_gradient(
        'This is quality test', "#ff22ff", "b00b1e", 'medium') == '\x1b[38;2;250;32;243mTh\x1b[38;2;242;30;219mis\x1b[38;2;234;27;195m i\x1b[38;2;225;25;172ms \x1b[38;2;217;23;148mqu\x1b[38;2;209;20;124mal\x1b[38;2;200;18;101mit\x1b[38;2;192;15;77my \x1b[38;2;184;13;53mte\x1b[38;2;176;11;30mst\x1b[0m'
    assert ansy.colored_gradient(
        'This is quality test', "#ff22ff", "b00b1e", 'low') == '\x1b[38;2;238;29;207mThis \x1b[38;2;217;23;148mis qu\x1b[38;2;196;17;89mality\x1b[38;2;176;11;30m test\x1b[0m'
...
def test_make_gradient():
    ...
    expected = [(255, 100, 100), (203, 87, 100),
                (152, 75, 100), (101, 62, 100), (50, 50, 100)]
...
def test_search_colors():
    expected = [('plum', 183), ('plum_1', 176), ('plum_2', 219),
                ('plum_dim', 96), ('plum_dim_1', 139)]
...
def test_is_valid_rgb():
    ...
    invalids = [(), (255, 1), (-50, -5, 255), (500, 1000, 100),
                (None), (123), ('123')]
    for v in invalids:
...
def test_is_valid_color():
    valids = [('yellow', 4), ('aquamarine', 8), ('yellow', 8),
              ('#fff', 24), ((255, 255, 100), 24)]
    for v in valids:
        assert ansy.is_valid_color(*v) == True

    invalids = [
        ('aquamarine', 4), ('aquamarine', 24), ('yellow', 24), ('#fff', 4),
        ('#fff', 8), ('#safsaf', 4), ('#safsaf', 8), ('#safsaf', 24),
        ((255, ), 4), ((255, ), 8), ((255, ), 24), ((255, 255, 100), 4),
        ((255, 255, 100), 8)
    ]
    for v in invalids:
